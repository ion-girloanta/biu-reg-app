          ...
          <div className="w-full max-w-[955px]">
            ...
            <div className="flex flex-col items-center gap-[48px] pt-[88px] min-h-[938px]">
              ...
              <div className="flex flex-row gap-[32px] w-full max-w-[955px]">
                {/* Card 1 - Check */}
                <div className="w-[484px] h-[180px] bg-[#F5FAF0] rounded-[16px] p-10" style={{boxShadow: '0 8px 12px -2px rgba(0, 0, 0, 0.08), 0 2px 6px -2px rgba(0, 0, 0, 0.06)', border: '2px solid red'}}>
