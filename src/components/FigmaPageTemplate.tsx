          ...
          <div className="max-w-[1131px] w-full">
            ...
            <div className="flex flex-col items-center gap-12 lg:gap-16">
              ...
              <div className="flex flex-col lg:flex-row gap-8 w-full max-w-[1000px]">
                {/* Card 1 - Clock */}
                <div className="flex-1 bg-[#F5FAF0] border border-[#DFE3F3] rounded-2xl p-8 shadow-lg">
                  <div className="flex items-start gap-10">
                    <div className="w-[68px] h-[68px] relative flex-shrink-0">
                      <div className="w-full h-full bg-white rounded-full shadow-md flex items-center justify-center">
                        <svg width="42" height="42" viewBox="0 0 53 54" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl font-bold text-black mb-4">כדאי להכין מראש</h3>
                      <p className="text-xl text-black leading-6">צילום של תעודת הזהות.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex-1 bg-[#F5FAF0] border border-[#DFE3F3] rounded-2xl p-8 shadow-lg">
                  <div className="flex items-start gap-10">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl font-bold text-black mb-4">כדאי לדעת</h3>
                      <p className="text-xl text-black leading-6">במקרה של ביטול רישום – ניתן לקבל החזר מלא של דמי הרישום, אם הביטול נעשה תוך 24 שעות.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center gap-10">
                <div className="flex flex-col items-center gap-4">
                  <h3 className="text-base text-black text-center">באיזו שפה נוח לך?</h3>
                  ...
                  <div className="flex flex-col sm:flex-row gap-8 justify-center items-center">
                    ...
                    >
                      <span className="flex-1 text-xl text-[#00280F] text-center">EN</span>
                      <img 
                    ...
                    >
                      <span className="flex-1 text-xl text-[#00280F] text-center">עברית</span>
                      <img 
                ...
                {/* Primary CTA */}
                <button className="px-6 py-4 bg-biu-green text-white text-xl font-medium rounded hover:bg-biu-green/90 transition-colors">
                  שנכיר
                </button>
              </div>
            </div>
